...
const validateData = (data) => {
  ...
  if (data.secretary_email?.length === 0)
    return "Please enter society secretary email.";
  return null;
};
    ...
    <>
      ...
      <div className="card rounded-md p-10">
        ...
        <Dialog open={editModal}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle className="pb-4">Edit Society Details</DialogTitle>
              <DialogDescription className="overflow-y-auto scrollbar  max-h-[500px]">
                <div className="max-h-[60vh]">
                  ...
                  <div className="mb-5 flex-grow  px-4">
                    ...
                    <Input
                      onChange={(e) =>
                        handleInputChange("secretary_email", e.target.value)
                      }
                      type="email"
                      placeholder="Enter your email"
                      required
                  ...
                  <Button
                    variant="default"
                    className="bg-[#0065C1] flex ml-auto mr-10"
                    onClick={editSociety}
                  >
                    Save Changes
                  </Button>
